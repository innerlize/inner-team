  ...
  return (
    ...
    <Navbar className="mx-auto w-[100%] sticky top-0"
      ...
      <div className="hidden lg:inline-block w-[100%] ">
        ...
        <div className=" flex items-center justify-evenly text-blue-gray-900 w-100" style={{ background: '#225890', padding: '0', margin: '0', maxHeight: "35px" }}>

          <div className="redes flex items-center gap-4 pb-3 pt-2" style={{ color: "#FFFFFF" }}>
          ...
          <div className='flex justify-center'>
						<a href="https://www.facebook.com/inner.team.ar/" className='flex justify-center items-center w-[45px] h-[35px] transition-[all] duration-[300ms] hover:bg-[#06D7F9]'>
						...
						<a href="https://www.instagram.com/inner.team.ar/" className='flex justify-center items-center w-[45px] h-[35px] transition-[all] duration-[300ms] hover:bg-[#06D7F9]'>
						...
						<a href="https://www.linkedin.com/company/inner-team/" className='flex justify-center items-center w-[45px] h-[35px] transition-[all] duration-[300ms] hover:bg-[#06D7F9]'>
