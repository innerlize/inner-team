		...
		<section className='relative w-full h-full bg-[#225890]'>
			...
			<div className='px-[16px] lg:px-[220px] py-[100px]'>
				...
				<div className='mt-[120px]'>
					<Link to='/blog/details4' onClick={() => scrollToTop()} className='flex items-center text-[#54E280] font-light'><svg className='mr-[15px]' width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
